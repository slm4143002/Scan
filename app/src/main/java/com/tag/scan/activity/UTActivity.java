...
public class UTActivity extends AppCompatActivity implements View.OnClickListener {

    protected TextView title, right;
    private LinearLayout back;
    private EditText txtCardNo,txtReceiptNo;
    private Button btnCardNo,btnReceiptNo;
    private Button btnOK,btnLo,btnUpload;
    ...
    public void initView() {
        ...
        txtReceiptNo = (EditText) findViewById(R.id.txt_receipt_no);
        txtReceiptNo.requestFocus();
        txtCardNo = (EditText) findViewById(R.id.txt_card_no);
        txtCardNo.requestFocus();

        btnCardNo = (Button) findViewById(R.id.btn_card_no);
        btnReceiptNo = (Button) findViewById(R.id.btn_receipt_no);
        btnOK = (Button) findViewById(R.id.btn_ok);
        btnLo = (Button) findViewById(R.id.btn_lo);
        btnUpload = (Button) findViewById(R.id.btn_upload);

        btnCardNo.setOnClickListener(this);
        btnReceiptNo.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_receipt_no:
                ...
                break;
            case R.id.btn_ok:
//                btnOK.setBackgroundDrawable(getResources().getDrawable(R.drawable.button_bg1));
            ...
            case R.id.btn_upload:
                if (TextUtils.isEmpty(txtCardNo.getText().toString().trim()) || TextUtils.isEmpty(txtReceiptNo.getText().toString().trim())) {
                ...
                sendUpload(txtCardNo.getText().toString().trim(), txtReceiptNo.getText().toString().trim(), checkResult); // 1：ok 0：lo

//                finish();
//                Intent intent = new Intent(this, BatchCompletionFinishActivity.class);
//                intent.putExtra("batchNumber", "批量号显示");
//                startActivity(intent);
            ...
            if (intent.getAction().equals(ScanApplication.RES_ACTION)){
                ...
                if(scan_data!=null){
                    ...
                    if ("1".equals(buttonFlag)) {
                        txtCardNo.setText(scan_data);
                    } else if ("2".equals(buttonFlag)) {
                        txtReceiptNo.setText(scan_data);
                    }
                }
            }
        }
    ...
    public void sendUpload(String num1, String num2, String num3) {
        maskShow();
        OkHttpManager httpManager = ScanApplication.getOkHttpManager();

        httpManager.requestAsyncPost(URLUtil.SERVER_URL + URLUtil.UT_UPLOAD, new RequestResult<BatchProccessResult>() {
            @Override
            ...
            public void onSuccessful(BatchProccessResult entity) {
                ...
                // lo品
                if ("0".equals(num3)) {
                    Toast.makeText(UTActivity.this, "操作成功！", Toast.LENGTH_LONG).show();
                    txtCardNo.setText("");
                    txtReceiptNo.setText("");
                } else if ("1".equals(num3)) {
                    if (entity==null || TextUtils.isEmpty(entity.getBatchNumber())) {
                        Toast.makeText(UTActivity.this, "本次操作完成！", Toast.LENGTH_LONG).show();
                        txtCardNo.setText("");
                        txtReceiptNo.setText("");
                    } else {
                        finish();
                        Intent intent = new Intent(UTActivity.this, BatchCompletionFinishActivity.class);
                        intent.putExtra("batchNumber", entity.getBatchNumber());
                        startActivity(intent);
                    }
                }
            }
            ...
            public void onFailure(String errorMsg) {
                maskDismiss();
                Toast.makeText(UTActivity.this, errorMsg, Toast.LENGTH_LONG).show();
            }

        }, BatchProccessResult.class, new Param("cardInfo", num1), new Param("ticketInfo", num2), new Param("checkResult", num3));
    }
