...
public class WithstandVoltageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_withstand_voltage);
...
//        registerBroadcast();
    ...
    public void sendUpload(String num1, String num2) {
        ...
        httpManager.requestAsyncPost(URLUtil.SERVER_URL + URLUtil.WITHSTAND_VOLTAGE_UPLOAD, new RequestResult<BatchProccessResult>() {
            @Override
            ...
            public void onSuccessful(BatchProccessResult entity) {
                maskDismiss();
                Toast.makeText(WithstandVoltageActivity.this, "操作成功！", Toast.LENGTH_LONG).show();
            ...
            public void onFailure(String errorMsg) {
                maskDismiss();
                Toast.makeText(WithstandVoltageActivity.this, errorMsg, Toast.LENGTH_LONG).show();
            }
